<?php
return [
    'webTitle'      => 'ই-লার্নিং প্ল্যাটফর্ম',
    'nav'           => [
                        'home'      => 'হোম',
                        'about'     => 'এবাউট',
                        'contact'   => 'যোগাযোগ',
    ...
    'webApplicationAbout' => [
        'title' => 'পেশাদার ওয়েব অ্যাপ্লিকেশন',
        'about' => "পেশাদার ওয়েব অ্যাপ্লিকেশন ডেভেলপমেন্ট শেখার জন্য মৌলিক জ্ঞান, ব্যবহারিক দক্ষতা এবং আধুনিক সরঞ্জাম এবং প্রযুক্তির সাথে অভিজ্ঞতার সংমিশ্রণ অর্জন করা জড়িত। আপনাকে শুরু করতে সাহায্য করার জন্য এখানে একটি নির্দেশিকা রয়েছে:",
        'description' => [
